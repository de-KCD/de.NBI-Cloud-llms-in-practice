...
| Demo | What It Does | Time | Complexity |
|------|--------------|------|------------|
|[demo_03](#demo-03-simple-agent) | Simple tool-calling agent | 30 min | Beginner |
...
## License
This workshop material — README, manifests, and diagrams — is released under the Creative Commons Attribution 4.0 International license (CC BY 4.0).

The material may be shared and adapted for any purpose, including commercial use, provided that appropriate credit is given and any changes are indicated.
